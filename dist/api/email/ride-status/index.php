...
switch ($status) {
    case 'EN_ROUTE':
        ...
        $subject = '🚗 Votre chauffeur est en route #' . $reference . ' - ' . $transporterName;
    ...
    case 'PICKED_UP':
        ...
        $subject = '🏥 Prise en charge effectuée #' . $reference . ' - ' . $transporterName;
    ...
    case 'COMPLETED':
        ...
        $subject = '✅ Transport médicalisé terminé #' . $reference . ' - Merci de votre confiance';
    ...
    case 'CANCELLED':
        ...
        $subject = '❌ Demande de transport annulée #' . $reference;
    ...
    default:
        ...
        $headerSubtitle = 'Demande N° #' . htmlspecialchars($reference, ENT_QUOTES, 'UTF-8');
        $subject = '✓ Transport médicalisé validé #' . $reference . ' - ' . $transporterName;
